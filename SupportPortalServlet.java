...
public class SupportPortalServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (agent != null) {
            out.println("<p>Logged in as: <strong>" + StringEscapeUtils.escapeHtml4(agent) + "</strong></p>");
        }
        ...
        if (fileParam != null) {
            File file = new File("/var/acme/uploads/" + Paths.get(fileParam).getFileName().toString());
            try {
